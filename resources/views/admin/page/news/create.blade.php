                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-5">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <input type="radio" name="state" value="{{ trans("label.admin.news.state.s1") }}" @if(old("state") == config("const.state")[0]) checked @endif>
                                                        {{trans("label.admin.news.state.s1") }}
                                                    </div>
                                                    <div class="col-md-3">
                                                        <input type="radio" name="state" value="{{ trans("label.admin.news.state.s2") }}" @if(old("state") == config("const.state")[1]) checked @endif>
